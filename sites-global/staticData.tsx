export const StaticData = {
    Meta_title:" Papa John - Pizza Hub",
    Meta_description:"Visit Papa John | Papa John is your local great Pizza Hub. Find latest seasonal looks for Women, Men and kids, plus a huge range of homeware.",
